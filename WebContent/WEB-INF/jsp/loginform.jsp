          ...
          <div class="card" style="width: 25rem;">
            <div class="card-header">
              ...
              <div class="card-body">
                  ...
                  <form:form class="form-signin" method="POST" action="/SpringMVCExample/login" modelAttribute="user">
                    <div class="form-label-group">
                      <form:input path="email" type="email" id="inputEmail" class="form-control mb-2" placeholder="Email address"/>
                    </div>
                    <div class="form-label-group">
                    ...
                    <div class="mt-3">
                      <a href="http://localhost:8080/SpringMVCExample/registerForm" class="float-left text-dark">Register</a>
                    </div>
                  </form:form> 
              </div>
          </div>
